            ...
            <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>SDIT Tambun Islamic School</td>
                            <td>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    // $max = array($ref0 => 'SMA Jati Agung', $ref1 => 'SDIT Tambun Islamic School', $ref2 => 'SD Islam Istiqlal', $ref3 => 'SD IT Ulul Albab', $ref4 => 'MI PINK 03', $ref5 => 'SD IT Permata Hati');
                    // krsort($max);
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        $x = 1;
                        $max = array($ref0 => 'SD Jaya Suti Abadi', $ref1 => 'SDIT Tambun Islamic School', $ref2 => 'SD Islam Istiqlal', $ref3 => 'SD IT Ulul Albab', $ref4 => 'MI PINK 03', $ref5 => 'SD IT Permata Hati');
